...
object Launcher extends JFXApp {
  ...
  val clusterCanvas: canvas.ClusterCanvas = new canvas.CCBuilder().withHeight(CANVAS_HEIGHT).withWidth(CANVAS_WIDTH)
